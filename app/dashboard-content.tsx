          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <div className="flex items-center gap-8">
              <div className="text-right">
                <p className="text-4xl font-semibold text-slate-900 tabular-nums">96.2%</p>
                <p className="text-xs text-slate-400 uppercase tracking-wider mt-1">系统健康度</p>
              </div>
              <div className="w-px h-16 bg-slate-200" />
              <div className="text-right">
                <p className="text-4xl font-semibold text-emerald-600 tabular-nums">6</p>
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        <BentoGrid>
          <BentoCard colSpan={2} rowSpan={2} delay={0}>
            <div className="p-8 h-full"><CronJobsPanel /></div>
          </BentoCard>
          <BentoCard colSpan={1} delay={0.1}>
            <div className="p-6"><SystemMetrics /></div>
          </BentoCard>
          <BentoCard colSpan={1} delay={0.2}>
            <div className="p-6"><QuickActions /></div>
          </BentoCard>
